...
public class RedBack6 extends OpMode {
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            ...
            Path1 = follower.pathBuilder()
                    .addPath(new BezierLine(new Pose(88.0, 14), new Pose(88.0, 36)))
                    .setLinearHeadingInterpolation(Math.toRadians(60), Math.toRadians(180))
                    .build();

            Path2 = follower.pathBuilder()
                    .addPath(new BezierLine(new Pose(88.0, 36), new Pose(125.0, 34.939)))
            ...
            Path4 = follower.pathBuilder()
                    .addPath(new BezierLine(new Pose(88.0, 12.0), new Pose(125, 15.0)))
                    .setLinearHeadingInterpolation(Math.toRadians(60), Math.toRadians(180))
                    .build();

            Path5 = follower.pathBuilder()
                    .addPath(new BezierLine(new Pose(134.746, 15.0), new Pose(88.0, 8.0)))
