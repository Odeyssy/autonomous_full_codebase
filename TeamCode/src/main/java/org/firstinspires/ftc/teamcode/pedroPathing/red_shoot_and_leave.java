...
@Autonomous(name = "Red Simple Shoot & Park", group = "Autonomous")
public class red_shoot_and_leave extends OpMode {
    ...
    /*
     *  0  -> Start flywheels, drive to (88, 15)
     *  1  -> Wait for arrival
     *  10 -> Shoot @ (88, 15)
     *  11 -> Wait for volley, then park to (133.026, 10.252)
     * 100 -> Stop everything
     */
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            // Start (88, 8) -> Shooting pos (88, 15)
            PathToShoot = follower.pathBuilder()
                    .addPath(new BezierLine(new Pose(88.000, 8.000), new Pose(88.000, 15.000)))
                    .setLinearHeadingInterpolation(Math.toRadians(90), Math.toRadians(60))
                    .build();

            // (88, 15) -> Park (133.026, 10.252)
            PathToPark = follower.pathBuilder()
                    .addPath(new BezierLine(new Pose(88.000, 15.000), new Pose(133.026, 10.252)))
