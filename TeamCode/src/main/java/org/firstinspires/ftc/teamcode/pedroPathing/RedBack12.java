...
@Autonomous(name = "Red BACK 12 Artifact (TESTING)", group = "Autonomous")
@Configurable
public class RedBack12 extends OpMode {
    ...
    public void init() {
        ...
        // Set starting pose to 72, 8 as requested
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            // Updated to start at 72, 8 to match init
            ShootPreloaded = follower.pathBuilder().addPath(
                            new BezierLine(new Pose(72.000, 8.000), new Pose(88.000, 8.000)))
            ...
            ToThird3 = follower.pathBuilder().addPath(
                    ...
                    .setLinearHeadingInterpolation(Math.toRadians(52), Math.toRadians(180)).build();
